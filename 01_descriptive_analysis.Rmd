...
st_geometry(comunidades_info_total[comunidades_info_total$MNOMCP == "CABO PANTOJA", ]) <-
  st_sfc(st_point(c(-73.248636296, -3.777654358)))
...
comunidades_info_total <- comunidades_info_total %>% 
  mutate(
    geometry = ifelse(
      MNOMCP == "8 DE DICIEMBRE", st_sfc(st_point(c(-73.248636296, 
                                                    -3.777654358))),
      ifelse(MNOMCP == "CABO LOPEZ", st_sfc(st_point(c(-73.253457539, 
                                                       -3.781405681))),
             ifelse(MNOMCP == "TIMICURO GRANDE",
                    st_sfc(st_point(c(-73.023866667, 
                          -3.558536667))), geometry)
  )
...
table_1_ind %>%
  as_flex_table() %>%
  flextable::save_as_docx(path = "./02_output/reports/table1_ind.docx")
```
...
table_1_household %>%
  as_flex_table() %>%
  flextable::save_as_docx(path = "./02_output/reports/table_1_household.docx")
```
...
table2_ind %>%
  as_flex_table() %>%
  flextable::save_as_docx(path = "./02_output/reports/table2_ind.docx")
```
